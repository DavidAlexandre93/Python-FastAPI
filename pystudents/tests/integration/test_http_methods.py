...
from tests.fixtures import student, student_name  # noqa: F401
...
class TestStudentsApi:
    ...
    async def test_success_create_student(self, student: StudentType) -> None:
        """
    ...
    async def test_success_retrieve_student(self, student: StudentType) -> None:
        """
    ...
    async def test_fail_retrieve_student(self, student: StudentType) -> None:
        """
    ...
    async def test_success_retrieve_all_students(self, student: StudentType) -> None:
        """
    ...
    async def test_success_update_student(
    ...
    async def test_fail_update_student(self, student_name: StudentType) -> None:
        """
    ...
    async def test_success_delete_student(self, student: StudentType) -> None:
        """
    ...
    async def test_fail_delete_student(self) -> None:
        """
