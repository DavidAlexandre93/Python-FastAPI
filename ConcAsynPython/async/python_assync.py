...
def main():
    ...
    computar(inicio=1, fim=10_000_000)
    computar(inicio=10_000_001, fim=20_000_000)
    computar(inicio=20_000_001, fim=30_000_000)
    computar(inicio=30_000_001, fim=40_000_000)
    computar(inicio=40_000_001, fim=50_000_000)
...
if __name__ == '__main__':
    ...
    #el = asyncio.get_event_loop()
    #main = el.create_task(main())
    #tarefas = asyncio.gather(main)
    #el.run_until_complete(tarefas)
